...
class Marcadores{
    ...
    agregarEventListeners(){
        ...
        }); //pulsacion de tecla sobre campo de URL
    ...
    generarHtmlMarcador(marcador){
        return `<div class="enlace"> <h3>${marcador.titulo}</h3><p><a href="${marcador.url}">${marcador.url}</a></p></div>`;
    }
    ...
    abrirEnlaceMarcador(evento){ //permite que no se abra la pagina en la aplicacion, sino en el navegador
